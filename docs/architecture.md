...
graph TD
    subgraph eduroam階層構造
        ...
        FLR --- RADIUS["機関RADIUSサーバー<br>radius.kobedenshi.ac.jp<br>(IdP + SP)"]
    end
...
flowchart TD
    ...
    CHECK -- "@kic.ac.jp" --> LOCAL2["ローカル認証<br>(inner-tunnel)<br>※将来対応"]
...
graph TD
    ...
    G1["cn=eduroam-users<br>memberUid: testuser1, testuser2"]
